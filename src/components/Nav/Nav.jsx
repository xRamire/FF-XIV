...
import './styles.css'
import BgSound from '../Sound/BgSound';


function Nav({ coverHidden }) {
    return (
        <nav>
            <div className='container auto'>
                <div className='content nav-content'>
                    <div>
                        <Link to='/'>
                            <div className='nav-logo'>
                                <svg fill='#fff' version="1.0" id="katman_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 100 800 350" xmlSpace="preserve">
                                    <g>
                    ...
                    <div>
                        <BgSound coverHidden={coverHidden} />
                    </div>
                </div>
            </div>
        </nav>
