        ...
        >
            <article className='content-article race-article padd-m-t-25'>
                <div className='race-title'>
                    <div><h2 className='race-name'>ROEGADYN</h2></div>
                    <div>
                ...
                <div className='race-types'>
                    <div className='race-types-content'>
                        <motion.div animate={{ opacity: raceType === 1 ? 1 : 0.3, transition: { duration: 0.3 } }} className="race-img race-img1">
                            <img style={{ 'width': '18vh' }} className='img1' src={RaceImg1} alt="SEA WOLVES" />
                            <img style={{ 'width': '18vh' }} className='img2' src={RaceImg2} alt="SEA WOLVES" />
                        </motion.div>
                        <div>
                        ...
                        <motion.div animate={{ opacity: raceType === 2 ? 1 : 0.3, transition: { duration: 0.3 } }} className="race-img race-img2">
                            <img style={{ 'width': '20vh' }} className='img1' src={RaceImg3} alt="HELLSGUARD" />
                            <img style={{ 'width': '18vh' }} className='img2' src={RaceImg4} alt="HELLSGUARD" />
                        </motion.div>
                    </div>
                </div>
            </article>
